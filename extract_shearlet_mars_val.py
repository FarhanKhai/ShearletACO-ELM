...
# ==========================
# 1. PARAMETER DATASET (VALIDASI)
# ==========================
DATA_ROOT   = "."
LABEL_FILE  = os.path.join(DATA_ROOT, "val-calibrated-shuffled.txt")  # BACA FILE VAL
OUTPUT_NPZ  = os.path.join(DATA_ROOT, "shearlet_val.npz")             # OUTPUT VAL
...
def main():
    ...
    print("Saved VALIDATION features to:", OUTPUT_NPZ)
