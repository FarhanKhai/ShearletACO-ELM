...
# ==========================
# 1. PARAMETER DATASET (VAL)
# ==========================
DATA_ROOT   = "."
LABEL_FILE  = os.path.join(DATA_ROOT, "val-calibrated-shuffled.txt")
OUTPUT_NPZ  = os.path.join(DATA_ROOT, "shearlet_val.npz")
...
def main():
    ...
    print("Total val samples:", len(pairs))
    ...
    if not X_list:
        print("Tidak ada sampel val yang berhasil diproses.")
        return
