...
# ==========================
DATA_ROOT   = "."
LABEL_FILE  = os.path.join(DATA_ROOT, "test-calibrated-shuffled.txt")
OUTPUT_NPZ  = os.path.join(DATA_ROOT, "shearlet_test.npz")
...
def main():
    ...
    print("Total test samples:", len(pairs))
    ...
    if not X_list:
        print("Tidak ada sampel test yang berhasil diproses.")
        return
